    ...
    >
      ...
      <div className="space-y-1">
        ...
        <DropdownOption
          ...
          setSelected={setSelected}
          dropdownItems={[
            { title: "الطلاب", Icon: Icons.student, notifs:2 },
            { title: "المدرسين", Icon: Icons.teacher, notifs:1 },
            { title: "الموظفين", Icon: Icons.staff, notifs:1},
          ]}
        />
...
const Option = ({ Icon, title, selected, setSelected, notifs, isOpen }) => {
  return (
    <motion.button
      dir="rtl"
      layout
      onClick={() => setSelected(title)}
      className={`relative flex h-10 w-full items-center rounded-md transition-colors ${selected === title || isOpen ? "bg-indigo-100 text-indigo-800" : "text-slate-500 hover:bg-slate-100"}`}
    >
      <motion.div
        layout
      ...
      >
        {title}
        <span className="pl-[20px] text-[24px]">
        {title === "المستخدمين" && 
        <FiChevronDown className={`${isOpen && 'transform rotate-180 transition duration-500'} transform transition duration-500 `}/>
        }
        </span>
      </motion.span>
